...
const app = express();
// Port sur lequel nous allons démarrer notre API REST par la suite. En local port = 3000 car process.env.port vaut undefined, sur Heroku, aura la valeur attribuée dynamiquement par Heroku sur l'environnement de prod.
